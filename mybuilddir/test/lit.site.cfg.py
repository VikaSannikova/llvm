## Autogenerated from C:/tetsLLVM/llvm/test/lit.site.cfg.py.in
## Do not edit!
...
config.llvm_lib_dir = "C:/tetsLLVM/llvm/mybuilddir/$(Configuration)/lib"
config.llvm_shlib_dir = "C:/tetsLLVM/llvm/mybuilddir/%(build_mode)s/bin"
config.llvm_shlib_ext = ".dll"
config.llvm_exe_ext = ".exe"
config.lit_tools_dir = ""
config.python_executable = "C:/ProgramData/Anaconda3/python.exe"
config.gold_executable = "C:/Program Files/mingw-w64/x86_64-7.3.0-win32-seh-rt_v5-rev0/mingw64/bin/ld.gold.exe"
...
config.host_cc = "C:/Program Files (x86)/Microsoft Visual Studio/2017/Community/VC/Tools/MSVC/14.12.25827/bin/Hostx86/x86/cl.exe "
config.host_cxx = "C:/Program Files (x86)/Microsoft Visual Studio/2017/Community/VC/Tools/MSVC/14.12.25827/bin/Hostx86/x86/cl.exe "
...
lit_config.load_config(config, "C:/tetsLLVM/llvm/test/lit.cfg.py")
